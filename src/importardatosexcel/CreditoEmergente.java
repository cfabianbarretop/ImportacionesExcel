...
//                guardarCabecera(data.get(0)[1], data.get(0)[3], data.get(1)[1], data.get(1)[3], data.get(1)[5], data.get(2)[1], data.get(2)[4], data.get(2)[6], data.get(3)[2], data.get(3)[10]);
                for (int i = 5; i < data.size(); i++) {
                    ...
                    System.out.println("");
//                    guardarDetalle(data.get(i)[0], data.get(i)[1], data.get(i)[2], data.get(i)[3], data.get(i)[4], data.get(i)[5], data.get(i)[6], data.get(i)[7], data.get(i)[8], data.get(i)[9], data.get(i)[10], data.get(i)[11]);
                }
                cn.close();
                data.clear();
            } catch (IOException e) {
    ...
    public static void guardarCabecera(String p1, String p2, String p3, String p4, String p5, String p6, String p7, String p8, String p9, String p10
    ) throws ClassNotFoundException {
        if (cn != null) {
            try {
                CallableStatement cst = cn.prepareCall("{call pcrear_cab_cre_eme (?,?,?,?,?,?,?,?,?,?)}");
                cst.setString(1, p1);
                cst.setString(2, p2);
                cst.setString(3, p3);
                cst.setString(4, p4);
    ...
    public static void guardarDetalle(String p1, String p2, String p3, String p4, String p5, String p6, String p7, String p8, String p9, String p10, String p11, String p12
    ) throws ClassNotFoundException {
        if (cn != null) {
            try {
                CallableStatement cst = cn.prepareCall("{call pcrear_det_cre_eme (?,?,?,?,?,?,?,?,?,?,?,?)}");
                cst.setString(1, p1);
                cst.setString(2, p2);
                cst.setString(3, p3);
                cst.setString(4, p4);
                ...
                cst.setString(9, p9);
                cst.setString(10, p10);
                cst.setString(11, p11);
                cst.setString(12, p12);
                cst.execute();
                cst.close();
            } catch (SQLException e) {
                System.err.println("ERROR en el procedimiento de la cabecera\n" + e);
